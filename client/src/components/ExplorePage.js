...
class ExplorePage extends Component {
  ...
  componentDidMount () {
    axios.get(`${config.BE_Domain}/get-tags`).then(res => {
      console.log(res);
      console.log(res.data);
      this.setState({tag: res.data});
      })

    axios.get(`${config.BE_Domain}/quizset/get-all-quizset`).then(res => {
    console.log(res);
    console.log(res.data);
  ...
  handleTagQuizSet(selectedTag) {
    if (selectedTag === "All") {
      axios.get(`${config.BE_Domain}/quizset/get-all-quizset`, {
      }).then(res => {
        this.setState({quizsets:res.data})
      ...
      // Show specific tags
        axios.post(`${config.BE_Domain}/quizset/get-tag-quizset`, {
        tag: selectedTag
      }).then(res => {
        console.log(res);
        console.log(res.data);
