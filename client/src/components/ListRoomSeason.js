...
class ListRoomSeason extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentDidMount(){
      ...
      this.state.socket.on('update room list allow season' , (messages) => {
