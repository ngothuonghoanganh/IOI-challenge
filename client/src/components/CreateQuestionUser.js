...
// ]
class CreateQuestionUser extends Component {
  constructor() {
    super();
    this.state = {
    ...
    switch(true) {
      ...
      case picture != null && picture !== "":
        return  <Segment placeholder size='large' >
                <Image centered src={picture} size="medium"/>
                               <Segment.Inline> 
                                 <Button disabled="true" type="button" id="file" primary onClick={this.removeImage}>Remove Image</Button>
                              </Segment.Inline>
                </Segment>
      default:
        return   <Segment placeholder size='large'><Header icon>
                       ...
                       <label for="file" class="ui icon button">
                           <i class="file icon"></i>
                           Open File</label>
                       <input disabled="true" type="file" id="file" name="file" hidden onChange={this.onChange}/>
                       
                       <Button disabled="true" type="button" id="file" primary onClick={this.uploadFiles}>Upload File</Button>
                       </Segment.Inline>
    ...
    <Grid>
      ...
      <Grid.Row centered verticalAlign='center'>
         <Grid.Column width={6}>
          {/* <Label size="big">Answer</Label> */}
          <Menu compact>
            <Dropdown placeholder='Answer' disabled="true" options={options}  onChange={(e,{value}) => 
              { this.setState({answer: value})}} value={this.state.answer} selection />
          </Menu>
      </Grid.Column>
            <Grid.Column width={4}>
...
export default CreateQuestionUser